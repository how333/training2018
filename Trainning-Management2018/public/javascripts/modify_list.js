...
$(document).ready(function() {
   ...
   // Empty content string
    ...
    $.getJSON( '/make_exam/list', {exam_code: exam_code}, function( data ) {
        ...
        if(response_data.score_subject)
        {
...
$('#NameList').change(function() {
    ...
    response_data_all.forEach(function(response_data){
        if(name == response_data.username)
        {
                ...
                response_score = response_data.score_subject;
    ...
    for(var temp in exam_obj_subjective)
    {
        ...
        content_temp +=   '<strong>Question'+$qno+':</strong><span>'+exam_obj_subjective[temp].question+'</span>';
        content_temp +=   '<span>('+exam_obj_subjective[temp].figures+')</span><br>';
        content_temp +=   '<strong>Response'+$qno+':</strong><span>'+response_content[temp]+'</span><br><br>';
        content_temp +=   '<strong>Score'+$qno+':</strong><input type="text" name="subject_score" value="'+response_score[temp]+'"><br><br>';
